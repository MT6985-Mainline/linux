...
/* 7.2 pinctrl-paris.h dropped MTK_PIN_NODRV; MT6985 pins carry no legacy
 * drive-strength group (adv_drive only), so keep the 5.15 macro here. */
#ifndef MTK_PIN_NODRV
#define MTK_PIN_NODRV(_number, _name, _eint, ...) {			.number = _number,					.name = _name,						.eint = _eint,						.funcs = (struct mtk_func_desc[]){				__VA_ARGS__, { } },			}
#endif
