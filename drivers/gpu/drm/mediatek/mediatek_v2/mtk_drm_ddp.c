...
/*For MT6895*/
/* MT6985 mutex and dual display-system definitions. */
...
static const unsigned int mt6985_mutex_sof[DDP_MUTEX_SOF_MAX] = {
	...
	[DDP_MUTEX_SOF_DSI0] = MT6985_MUTEX_SOF_DSI0 | MT6985_MUTEX_EOF_DSI0,
	[DDP_MUTEX_SOF_DSI1] = MT6985_MUTEX_SOF_DSI1 | MT6985_MUTEX_EOF_DSI1,
	[DDP_MUTEX_SOF_DPI0] = MT6985_MUTEX_SOF_DPI0 | MT6985_MUTEX_EOF_DPI0,
	[DDP_MUTEX_SOF_DPI1] = MT6985_MUTEX_SOF_DPI1 | MT6985_MUTEX_EOF_DPI1,
};

static const unsigned int mt6985_mutex_ovlsys_sof[DDP_MUTEX_SOF_MAX] = {
	[DDP_MUTEX_SOF_SINGLE_MODE] = MT6985_MUTEX_SOF_SINGLE_MODE,
	[DDP_MUTEX_SOF_DSI0] = MT6985_MUTEX_OVLSYS_SOF_DSI0 |
		MT6985_MUTEX_OVLSYS_EOF_DSI0,
	[DDP_MUTEX_SOF_DSI1] = MT6985_MUTEX_OVLSYS_SOF_DSI1 |
		MT6985_MUTEX_OVLSYS_EOF_DSI1,
	[DDP_MUTEX_SOF_DPI0] = MT6985_MUTEX_OVLSYS_SOF_DPI0 |
		MT6985_MUTEX_OVLSYS_EOF_DPI0,
	[DDP_MUTEX_SOF_DPI1] = MT6985_MUTEX_OVLSYS_SOF_DPI1 |
		MT6985_MUTEX_OVLSYS_EOF_DPI1,
};
...
static const struct mtk_disp_ddp_data mt6985_ddp_driver_data = {
	...
	.mutex_mod_reg = MT6985_DISP_MUTEX0_MOD0,
	.mutex_sof_reg = MT6985_DISP_MUTEX0_SOF,
...
const struct mtk_mmsys_reg_data mt6985_mmsys_reg_data = {
	/* MT6985 uses the MT6983-compatible RDMA0 selector layout. */
	.rdma0_sout_sel_in = MT6983_DISP_RDMA0_SEL_IN,
	.dispsys_map = mt6985_dispsys_map,
};
