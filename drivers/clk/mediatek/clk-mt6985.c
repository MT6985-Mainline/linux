...
/*
 * Downstream MT6985 uses old vendor mux APIs not present in this tree.
 * Map them onto the 7.2 equivalents: MUX_HWV becomes the HWV gate/mux
 * variant, MUX_IPI_FLAGS collapses onto the plain HWV mux and drops the
 * IPI/quick-switch/default-opp semantics (not used for bring-up).
 */
...
static const struct mtk_mux top_muxes[] = {
	...
	MUX_GATE_HWV_CLR_SET_UPD(CLK_TOP_VDEC_SEL/* dts */, "vdec_sel", vdec_parents/* parent */, CKSYS2_CLK_CFG_14, CKSYS2_CLK_CFG_14_SET, CKSYS2_CLK_CFG_14_CLR/* set parent */, HWV_CG_27_DONE, HWV_CG_27_SET, HWV_CG_27_CLR, 8/* lsb */, 4/* width */, 15/* pdn */, CKSYS2_CLK_CFG_UPDATE1/* upd ofs */, TOP_MUX_VDEC_SHIFT/* upd shift */),
	/* CKSYS2_CLK_CFG_16 */
	...
	/* CKSYS2_CLK_CFG_17 */
	MUX_GATE_HWV_CLR_SET_UPD(CLK_TOP_IMG1_SEL/* dts */, "img1_sel", img1_parents/* parent */, CKSYS2_CLK_CFG_17, CKSYS2_CLK_CFG_17_SET, CKSYS2_CLK_CFG_17_CLR/* set parent */, HWV_CG_29_DONE, HWV_CG_29_SET, HWV_CG_29_CLR, 0/* lsb */, 4/* width */, 7/* pdn */, CKSYS2_CLK_CFG_UPDATE2/* upd ofs */, TOP_MUX_IMG1_SHIFT/* upd shift */),
	MUX_GATE_HWV_CLR_SET_UPD(CLK_TOP_IPE_SEL/* dts */, "ipe_sel", ipe_parents/* parent */, CKSYS2_CLK_CFG_17, CKSYS2_CLK_CFG_17_SET, CKSYS2_CLK_CFG_17_CLR/* set parent */, HWV_CG_29_DONE, HWV_CG_29_SET, HWV_CG_29_CLR, 8/* lsb */, 4/* width */, 15/* pdn */, CKSYS2_CLK_CFG_UPDATE2/* upd ofs */, TOP_MUX_IPE_SHIFT/* upd shift */),
	MUX_GATE_HWV_CLR_SET_UPD(CLK_TOP_CAM_SEL/* dts */, "cam_sel", cam_parents/* parent */, CKSYS2_CLK_CFG_17, CKSYS2_CLK_CFG_17_SET, CKSYS2_CLK_CFG_17_CLR/* set parent */, HWV_CG_29_DONE, HWV_CG_29_SET, HWV_CG_29_CLR, 16/* lsb */, 4/* width */, 23/* pdn */, CKSYS2_CLK_CFG_UPDATE2/* upd ofs */, TOP_MUX_CAM_SHIFT/* upd shift */),
		...
		int num_plls)
{
	...
	r = mtk_clk_register_plls(&pdev->dev, plls, num_plls,
			clk_data);
